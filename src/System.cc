...
Sophus::SE3f System::TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp, const vector<cv::Mat>& mask, const vector<IMU::Point>& vImuMeas, string filename)
{
...
Sophus::SE3f System::TrackRGBD(const cv::Mat &im, const cv::Mat &depthmap, const double &timestamp, const vector<cv::Mat>& mask,const vector<IMU::Point>& vImuMeas, string filename)
{
...
Sophus::SE3f System::TrackMonocular(const cv::Mat &im, const double &timestamp, const vector<cv::Mat>& mask,const vector<IMU::Point>& vImuMeas, string filename)
{
